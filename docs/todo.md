...
- [x] Non-functional requirements ([tasks_list/12_non_functional.md](tasks_list/12_non_functional.md)) <!-- Partial: Lazy/Eager load and GroupList virtualization implemented, manual performance testing pending -->